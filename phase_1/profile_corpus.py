...
# The dataset workspace is the parent of the Git repository. Add the repository
# root to the module search path so this script can continue to reuse the
# inventory helpers after moving into phase_1/.
REPOSITORY_ROOT = Path(__file__).resolve().parents[1]
DEFAULT_DATASET_ROOT = REPOSITORY_ROOT.parent
